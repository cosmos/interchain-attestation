...
func (_Contract *ContractTransactor) SetNumber(opts *bind.TransactOpts, newNumber *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "setNumber", newNumber)
}

// SetNumber is a paid mutator transaction binding the contract method 0x3fb5c1cb.
//
// Solidity: function setNumber(uint256 newNumber) returns()
func (_Contract *ContractSession) SetNumber(newNumber *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.SetNumber(&_Contract.TransactOpts, newNumber)
}

// SetNumber is a paid mutator transaction binding the contract method 0x3fb5c1cb.
//
// Solidity: function setNumber(uint256 newNumber) returns()
func (_Contract *ContractTransactorSession) SetNumber(newNumber *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.SetNumber(&_Contract.TransactOpts, newNumber)
}
