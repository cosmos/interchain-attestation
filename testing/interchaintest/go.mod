...
replace (
	...
	github.com/strangelove-ventures/interchaintest/v8 => github.com/gjermundgaraba/interchaintest/v8 v8.0.0-20240819101942-efe30e3df0f1
)
...
replace (
	...
	github.com/cosmos/interchain-attestation/sidecar => ../../sidecar
