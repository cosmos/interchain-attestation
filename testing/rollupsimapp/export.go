...
// file.
func (app *RollupSimApp) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs, modulesToExport []string) (servertypes.ExportedApp, error) {
...
func (app *RollupSimApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) {
